 ...
 * Created on November 13, 2021, 3:29 PM
...
int main(int argc, char** argv) {
    ...
    cout<<"\nThe owner of the "<<((nPlayrs==2)?"two":"three")<<" of clubs is "
            <<players[first].name<<".\n";
...
Deck filDeck(short nPlyr){
    ...
    //Remove the 2D card if there are 3 players
    if (nPlyr==3)
...
void intro(){
    ...
    cout<<endl<<"The object of this game is to be the player with the\n"
        ...
        "out. The players then choose 3 cards to pass to the next\n"
        "player. The player with the 2 of Clubs (2C) leads the first\n"
